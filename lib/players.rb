...
class Players
  attr_accessor :second_prompt, :sort, :order, :rank_no, :single_player
	...
	def set_headers
		...
		headers =  "Rank".ljust(6), name.to_s.ljust(35), " | ", bye.to_s.center(10), " | ", points.to_s.center(10), " | ", ppg.to_s.center(10), " | "
	end
	...
	def print_players_for_given_method(array)
		...
		n.times do
			...
			bye = array[i][4]
			name = array[i][5]
			player = rank.to_s.rjust(4), ")".ljust(2), name.to_s.ljust(35), " | ", bye.to_s.center(10), " | ", points.to_s.center(10), " | ", ppg.to_s.center(10), " | ", age.to_s.center(10), " | "	
		i += 1
		print player.join() , "\n" 
		end
	end
